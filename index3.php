		...
		function checkScreen(){
	        if (/Android (\d+\.\d+)/.test(navigator.userAgent)) {
	            ...
	            if (version > 2.3) {
	                ...
	                document.write('<meta name="viewport" content="width=640, minimum-scale = ' + phoneScale +',initial-scale = '+phoneScale +', maximum-scale = ' + phoneScale + ', target-densitydpi=device-dpi">');
...
<!-- 	<video preload="auto" src="video/01.ogv" width="640" height="960"></video>
 -->
...
<script type="text/javascript" src="js/aniUI011.js"></script>
<script type="text/javascript" src="js/aniUI021.js"></script>
...
function loadMainUI () {
	lib.properties.manifest = ani1_lib;	
...
function handleComplete() {
	...
	// initUI("images/ani1_wt2.png","nickName");
	// initUI();
	// console.log(stage);
...
var _shareImgUrl = "http://"+window.location.host+"/mdbxcjhk/site/images/sharelogo.jpg" ;
...
<script type="text/javascript">
	// var len = lib.properties.manifest.length;
	// var n = 0;
	// function loadImg (argument) {
	// 	// body...
	// 	for (var i = 0; i < lib.properties.manifest.length; i++) {
	// 		var img = new Image();
	// 		img.id = lib.properties.manifest[0].id;
	// 		img.onload = function(evt) {
	// 			n++;
	// 			images[evt.target.id] = evt.target; 
	// 			if(n==len){
	// 				//加载完成
	// 			}
	// 		}
	// 		img.src = lib.properties.manifest[0].src;
