...
class Pager{
	...
	public function get_prev_page(){
		$string = "";
		if($this->currPage<=1){
			$string .= "<li class=\"active\"><a href=\"javascript:;\">上一页</a></li>" ;
		}else{
			$string .= "<li><a href=\"".$this->url()."page=".($this->currPage-1)."\">上一页</a></li>" ;
		}
		return $string ;
	}
	/**
	...
	public function get_next_page(){
		$string = "" ;
		if($this->currPage>=$this->getTotalPage()){
			$string .= "<li class=\"active\"><a href=\"javascript:;\">后一页</a></li>" ;
		}else{
			$string .= "<li><a href=\"".$this->url().$this->param_name."=".($this->currPage+1)."\">后一页</a></li>" ;
		}
		return $string ;
	}
	...
	public function get_list(){
		...
		if($this->getTotalPage()<=10){
			for($i=1;$i<=$this->getTotalPage();$i++){
				if($i==$this->currPage){
					$string .= "<li class=\"active\"><a href=\"javascript:;\" class=\"on\">".$i."</a></li>" ;
				}else{
					$string .= "<li><a href=\"".$this->url().$this->param_name."=".$i."\">".$i."</a></li>" ;
				}
			}
		}else{
			for($i=1;$i<=3;$i++){
			...
			if($this->currPage>5)$string .= "<li>...</li>" ;
			if($this->currPage>4){
				$min = $this->currPage-1 ;
			}else{
				$min = 4 ;
			...
			if($this->currPage<$this->getTotalPage()-4)$string .= "<li>...</li>" ;
