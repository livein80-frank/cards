...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{aniend:727});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(237).call(this.frame_237).wait(490).call(this.frame_727).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[]},153).wait(575));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(248).to({_off:false},0).wait(14).to({regX:0,regY:0,x:-154.9,y:-275.4},0).wait(12).to({startPosition:0},0).wait(15).to({startPosition:0},0).wait(14).to({startPosition:0},0).wait(11).to({startPosition:0},0).wait(12).to({startPosition:0},0).wait(12).to({startPosition:0},0).wait(16).to({startPosition:0},0).wait(12).to({startPosition:0},0).wait(13).to({startPosition:0},0).wait(11).to({startPosition:0},0).wait(18).to({startPosition:0},0).wait(28).to({startPosition:0},0).wait(30).to({startPosition:0},0).wait(9).to({startPosition:0},0).wait(8).to({startPosition:0},0).wait(7).to({startPosition:0},0).wait(7).to({startPosition:0},0).wait(16).to({startPosition:0},0).wait(24).to({startPosition:0},0).wait(29).to({startPosition:0},0).wait(7).to({startPosition:0},0).wait(10).to({startPosition:0},0).wait(8).to({startPosition:0},0).wait(9).to({startPosition:0},0).wait(12).to({startPosition:3},0).wait(9).to({startPosition:0},0).wait(79).to({startPosition:0},0).wait(13).to({startPosition:0},0).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(153).to({_off:false},0).to({_off:true},90).wait(485));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.gtInfoMc}]}).to({state:[]},153).to({state:[{t:this.btn}]},561).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(714).to({_off:false},0).wait(14));
